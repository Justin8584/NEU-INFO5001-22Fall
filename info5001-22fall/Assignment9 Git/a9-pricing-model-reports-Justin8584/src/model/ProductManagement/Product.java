...
public class Product {
    ...
    public Product(int fp, int cp, int tp, Supplier sp) {
    ...
    public Product(String n, int fp, int cp, int tp, Supplier sp) {
        name = n;
        floorPrice = fp;
        ceilingPrice = cp;
        targetPrice = tp;
    ...
    public void printSaleInfo() {
        System.out.println("    Product Name - " + name + " | Total Sale Volume " + getSalesVolume() + ". ");
    ...
    public void printProductInfo() {
        System.out.println("    Product Name - " + name + " |-> Floor $ " + floorPrice + " |-> Ceiling $ "
                + ceilingPrice + " |-> Target $ " + targetPrice + ".");
